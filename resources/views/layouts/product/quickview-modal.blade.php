                  ...
                  <div class="row gy-4">
                      <div class="col-lg-6">
                          <div class="shop-details-img">
                             <div class="tab-content" id="quickview-image-tabs">
                                 <div class="tab-pane fade show active" id="view-pills-img1" role="tabpanel">
                                      <div class="shop-details-tab-img">
                                          <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-tab-img1.png" alt="">
                                      </div>
                                  </div>
                                  <div class="tab-pane fade" id="view-pills-img2" role="tabpanel"
                                      >
                                      <div class="shop-details-tab-img">
                                          <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-tab-img2.png" alt="">
                                      </div>
                                  </div>
                                  <div class="tab-pane fade" id="view-pills-img3" role="tabpanel">
                                      <div class="shop-details-tab-img">
                                          <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-tab-img3.png" alt="">
                                      </div>
                                  </div>
                                  <div class="tab-pane fade" id="view-pills-img4" role="tabpanel">
                                      <div class="shop-details-tab-img">
                                          <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-tab-img4.png" alt="">
                                      </div>
                                  </div>
                              </div>
                             <div class="nav nav-pills" id="quickview-image-nav" role="tablist" aria-orientation="vertical">
                                  <button class="nav-link active" id="view-pills-img1-tab" data-bs-toggle="pill" data-bs-target="#view-pills-img1" type="button"
                                      ...
                                      <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-nav-img1.png" alt="">
                                  </button>
                                  <button class="nav-link" id="view-pills-img2-tab" data-bs-toggle="pill" data-bs-target="#view-pills-img2" type="button"
                                      ...
                                      <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-nav-img2.png" alt="">
                                  </button>
                                  <button class="nav-link" id="view-pills-img3-tab" data-bs-toggle="pill"
                                      ...
                                      <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-nav-img3.png" alt="">
                                  </button>
                                  <button class="nav-link" id="view-pills-img4-tab" data-bs-toggle="pill"
                                      ...
                                      <img src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/shop-details-nav-img4.png" alt="">
                                  </button>
                              </div>
                          </div>
                      </div>
                      <div class="col-lg-6">
                          <div class="shop-details-content">
                             <h1 id="quickview-title">Poutsicle Hydrating Lip Stain.</h1>
                             <p id="quickview-description">Aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos only
                              ...
                              <div class="price-area">
                                 <p class="price" id="quickview-price">$150.00 <del>$200.00</del></p>
                              </div>
                              <div class="quantity-color-area">
                                 ...
                                 <div id="quickview-variant-wrap" style="display:none;"></div>
                              </div>
                             <div class="shop-details-btn">
                                <a href="" class="primary-btn1 hover-btn3" id="quickview-buy-link">*Mua Ngay*</a>
                                 <a href="#" class="primary-btn1 style-3 hover-btn4" id="quickview-add-cart-btn">*Thêm vào giỏ hàng*</a>
                              </div>
                              <div class="product-info">
                                  <ul class="product-info-list">
                                      <li> <span>SKU:</span> 9852410</li>
                                      <li> <span>Thương hiệu:</span> <a href="shop-4-columns.html">Covyshrimp</a></li>
                                     <li> <span>Category:</span> <a href="#" id="quickview-category-link">Body</a></li>
                                  </ul>
                              </div>
                              <div class="payment-method">
                                  ...
                                  <ul class="payment-card-list">
                                      <li class="d-flex align-items-center">
                                          <img
                                              src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/payment-img1.svg"
                                              alt="COD"
                                              width="28"
                                              height="20"
                                              class="mr-2"
                                      ...
                                      <li class="d-flex align-items-center">
                                          <img
                                              src="https://demo.egenslab.com/html/beautico/preview/assets/img/inner-page/payment-img2.svg"
                                              alt="Online payment"
                                              width="28"
                                              height="20"
                                              class="mr-2"
