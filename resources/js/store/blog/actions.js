...
export const bulkDeleteBlogs = ({commit}, opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/blog/bulk-delete', opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        });
...
export const bulkUpdateBlogStatus = ({commit}, opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/blog/bulk-status', opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        });
...
export const bulkDuplicateBlogs = ({commit}, opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/blog/bulk-duplicate', opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        });
