...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	if ($('.banner-bg-slider').length) {
		new Swiper(".banner-bg-slider", {
			slidesPerView: 1,
			spaceBetween: 0,
			speed: 900,
			loop: true,
			...
			navigation: {
				nextEl: '.banner-bg-slider .swiper-button-next',
				prevEl: '.banner-bg-slider .swiper-button-prev',
			},
		});
	}
	...
	//service-carousel One
	if ($('.clients-swiper-two').length) {
		var swiper = new Swiper(".clients-swiper-two", {
			slidesPerView: 5,
			spaceBetween: 0,
			speed: 500,
			loop: true,
	...
	if ($('.testi-slider1-content').length) {
		var swiper = new Swiper(".testi-slider1-content", {
			speed: 1000,
			loop: true,
			slidesPerView: 1,
			spaceBetween: 30,
			autoplay: true,
			navigation: {
				nextEl: '.testi-slider-arrow-next',
				prevEl: '.testi-slider-arrow-prev',
			},
		});
	}
	...
	if ($('.blog-two-slider').length) {
		var swiper = new Swiper(".blog-two-slider", {
			speed:1500,
			loop: true,
			slidesPerView: 1.2,
			spaceBetween: 24,
  ...
  var TM_Pricing_Switcher_Btn = function ($scope) {
	...
	if ($.fn.bxSlider && $('.room-section-h1-two .bxslider').length) {
